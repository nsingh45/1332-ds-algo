...
public class StudentAVLTests {
    ...
    public void addThings() {
        avlInteger.add(new Integer(1));
        avlInteger.add(new Integer(2));
        avlInteger.add(new Integer(3));
        assertEquals(new Integer(2), (avlInteger.getRoot()).getData());
    }
