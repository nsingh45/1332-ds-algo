...
public class BSTStudentTests {
    ...
    public void testAdd() {
        ...
        assertEquals(new Integer(4), root.getLeft().getData());
        root = root.getLeft();
        assertEquals(new Integer(3), root.getLeft().getData());
        bst.clear();
        plantTree();
        root = bst.getRoot();
        root = (root.getLeft()).getLeft();
        assertEquals(new Integer(37), root.getData());
    }
    ...
    /*public void testParentGet() {
        plantTree();
        assertEquals(new Integer(79), bst.getParent(73));
        assertEquals(new Integer(89), bst.getParent(83));
        assertNull(bst.getParent(67));
    } */
